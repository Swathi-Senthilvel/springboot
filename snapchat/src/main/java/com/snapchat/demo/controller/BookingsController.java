...
import com.snapchat.demo.service.BookingsService;
...
public class BookingsController {
    ...
    public ResponseEntity<Optional<Bookings>> getBookingById(@PathVariable int ticket_id) {
        Optional<Bookings> booking = bookingRepository.findById(ticket_id);
        return ResponseEntity.ok(booking);
    }

    @PutMapping("/{ticket_id}")
    public Bookings updateBookingDetails(@RequestBody Bookings booking) {
...
public List<Bookings> sortBookings(@PathVariable String name)
{
...
public Page<Bookings> pagingBooking(@PathVariable int offset,@PathVariable int pageSize)
{
...
public List<Bookings> pagingAndSorting(@PathVariable int offset,@PathVariable int pageSize,@PathVariable String field) 
{
...
@GetMapping("/{prefix}")
public List<Bookings> fetchByPrefix(@RequestParam String prefix)
{
	return bookingService.fetchTeamByPrefix(prefix);
}
@GetMapping("/{suffix}")
public List<Bookings> fetchBySuffix(@RequestParam String suffix)
{
...
public List<Bookings> getBookingsByTeam(@PathVariable String team,@PathVariable String name)
{
...
List<Bookings>fetchPlayerByTeam(@PathVariable String team)
{
